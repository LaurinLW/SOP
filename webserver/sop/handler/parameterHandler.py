...
class ParameterHandler():
    ...
    def getParameters(self, request, algo_id):
        ...
        import_string = AlgorithmModel.objects.get(pk=algo_id).file.path.split("webserver\\")[1].replace("\\", "/")[:-3]
        import_path = "\"import\": " + '"' + import_string + '"' + ",\n"
        parameters = ""
        ...
        para = "{\n" + idalgo + import_path + parameters[:-2] + "\n}"
        return para
